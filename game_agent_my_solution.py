...
def custom_score(game, player):
    ...
    dist_to_center = (float((h - y) ** 2 + (w - x) ** 2)) ** 0.5

    return float(len(legal_moves1) - 1.2 * len(legal_moves2) + dist_to_center)
...
def custom_score_2(game, player):
    ...
    unique_moves1 = list(set(legal_moves1) - set(legal_moves2))
    unique_moves2 = list(set(legal_moves2) - set(legal_moves1))

    return float(len(unique_moves1) - 1.2*len(unique_moves2))
...
def custom_score_3(game, player):
    ...
    return float(len(legal_moves1) - 1.2*len(legal_moves2))
